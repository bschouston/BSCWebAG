...
export default function CheckoutSuccessPage() {
    ...
    useEffect(() => {
        ...
        // The webhook handles this authoritatively; this call is a client-side fallback.
    ...
    if (!sessionId) {
        return (
            <div className="container mx-auto px-4 py-24 flex flex-col items-center justify-center min-h-[60vh]">
                ...
                <h1 className="text-3xl font-bold mb-2 text-center">Invalid Page</h1>
                <p className="text-muted-foreground mb-8 text-center max-w-md">
                    This page can only be accessed after completing a checkout. If you believe this is
    ...
    return (
        <div className="container mx-auto px-4 py-24 flex flex-col items-center justify-center min-h-[60vh]">
            ...
            <p className="text-muted-foreground mb-8 text-center max-w-md">
                Thank you for your purchase. Your registration has been confirmed and a receipt has
