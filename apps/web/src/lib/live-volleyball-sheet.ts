/** Published “web” embed URL for the org volleyball tournament sheet (whole workbook, all tabs). */
...
export const VOLLEYBALL_LIVE_SHEET_IFRAME_HTML =
  `<iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTimMs2jAeC7UaoiPCBqtMLHWv4cLJir2STNCDyHwv-kHwC74PVG-piwgQTC94wJC7AKl5fpmacjLMv/pubhtml?widget=true&amp;headers=false"></iframe>`;
