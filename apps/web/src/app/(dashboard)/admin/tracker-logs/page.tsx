...
export default function TrackerLogsPage() {
  ...
  const load = useCallback(async () => {
    ...
    setRows(data.logs ?? []);
    setLoading(false);
  }, [user, email, tournamentId, matchId, action, sort]);
  ...
  return (
    <div className="space-y-4 max-w-7xl">
      <Card>
        <CardHeader>
          <CardTitle>Tracker activity log</CardTitle>
          <CardDescription>
            Logins, match tracking sessions, and stats recorded in the tracker console.
          </CardDescription>
        </CardHeader>
