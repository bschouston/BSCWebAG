...
"[project]/apps/web/src/components/events/photo-carousel.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PhotoCarousel.useEffect": ()=>{
            ...
            const id = window.setInterval({
                "PhotoCarousel.useEffect.id": ()=>{
                    setCurrent({
                        "PhotoCarousel.useEffect.id": (c)=>c === photos.length - 1 ? 0 : c + 1
                    }["PhotoCarousel.useEffect.id"]);
                }
            }["PhotoCarousel.useEffect.id"], 10000);
            return ({
                "PhotoCarousel.useEffect": ()=>window.clearInterval(id)
            })["PhotoCarousel.useEffect"];
        }
    }["PhotoCarousel.useEffect"], [
        photos.length
...
_s(PhotoCarousel, "Ce5S7Zpl2S4YgGoPn+G4m52qKq8=");
_c = PhotoCarousel;
var _c;
...
"[project]/apps/web/src/components/events/donation-section.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$cart$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/cart-context.tsx [app-client] (ecmascript)");
...
function DonationSection({ eventId }) {
    _s();
    const { addToCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$cart$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    ...
    const parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DonationSection.useMemo[parsed]": ()=>amount === "" ? null : Number(amount)
    }["DonationSection.useMemo[parsed]"], [
        amount
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DonationSection.useEffect": ()=>{
            if (!justAdded) return;
            const t = setTimeout({
                "DonationSection.useEffect.t": ()=>setJustAdded(false)
            }["DonationSection.useEffect.t"], 1600);
            return ({
                "DonationSection.useEffect": ()=>clearTimeout(t)
            })["DonationSection.useEffect"];
        }
    }["DonationSection.useEffect"], [
        justAdded
...
_s(DonationSection, "pv1Fp31JB+iiz6uc6kaCIvo2Pz8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$cart$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"]
    ];
});
_c = DonationSection;
var _c;
...
"[project]/apps/web/src/components/events/featured-event-nav.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FeaturedEventNav({ showHighlights, showFees, showDonate, showPlayers }) {
    ...
    const items = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FeaturedEventNav.useMemo[items]": ()=>{
            const base = [
                {
                    key: "details",
                    label: "Details",
            ...
            return base.filter({
                "FeaturedEventNav.useMemo[items]": (i)=>i.show
            }["FeaturedEventNav.useMemo[items]"]);
        }
    }["FeaturedEventNav.useMemo[items]"], [
        showDonate,
...
_s(FeaturedEventNav, "JuH2Tip3cwnoihIGVm6QoIvsF5k=");
_c = FeaturedEventNav;
var _c;
__turbopack_context__.k.register(_c, "FeaturedEventNav");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/apps/web/src/components/events/event-countdown.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EventCountdown({ countdownTo, eventStart, registrationStart, registrationEnd, registrationsClosedAt, registrationDeadline, eventLocation, addressUrl, genderPolicy, ageRestriction, participationLocale, showLocation = true, showGender = true, showAgeRestriction = true, showLocale = true }) {
    _s();
    const eventStartDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EventCountdown.useMemo[eventStartDate]": ()=>toDate(eventStart)
    }["EventCountdown.useMemo[eventStartDate]"], [
        eventStart
    ]);
    const regStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EventCountdown.useMemo[regStart]": ()=>toDate(registrationStart)
    }["EventCountdown.useMemo[regStart]"], [
        registrationStart
    ]);
    const regEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EventCountdown.useMemo[regEnd]": ()=>toDate(registrationEnd)
    }["EventCountdown.useMemo[regEnd]"], [
        registrationEnd
    ]);
    const closedAt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EventCountdown.useMemo[closedAt]": ()=>toDate(registrationsClosedAt)
    }["EventCountdown.useMemo[closedAt]"], [
        registrationsClosedAt
    ]);
    const deadlineAt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EventCountdown.useMemo[deadlineAt]": ()=>deadlineToLocalDate(registrationDeadline)
    }["EventCountdown.useMemo[deadlineAt]"], [
    ...
    const [now, setNow] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "EventCountdown.useState": ()=>new Date()
    }["EventCountdown.useState"]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EventCountdown.useEffect": ()=>{
            const t = setInterval({
                "EventCountdown.useEffect.t": ()=>setNow(new Date())
            }["EventCountdown.useEffect.t"], 1000);
            return ({
                "EventCountdown.useEffect": ()=>clearInterval(t)
            })["EventCountdown.useEffect"];
        }
    }["EventCountdown.useEffect"], []);
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        closesAtText && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        showLocation && (eventLocation || addressUrl) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                addressUrl && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                    href: addressUrl,
                                    target: "_blank",
                                    rel: "noreferrer",
                        ...
                        showGender && genderLabel ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex flex-col gap-2",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex items-center text-muted-foreground",
                        ...
                        showAgeRestriction && ageRestriction ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex flex-col gap-2",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex items-center text-muted-foreground",
                        ...
                        showLocale && participationLocale ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex flex-col gap-2",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex items-center text-muted-foreground",
...
_s(EventCountdown, "MoSkSAYecsTIZwzfpAWhubkvbxY=");
_c = EventCountdown;
var _c;
...
"[project]/apps/web/src/components/events/registration-cta.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function RegistrationCta({ registerHref, registrationDeadline, registrationEnd, registrationsClosedAt, className, showWhenNoDeadline = true, closedLabel = "Registration closed" }) {
    _s();
    const deadlineAt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RegistrationCta.useMemo[deadlineAt]": ()=>deadlineToLocalDate(registrationDeadline)
    }["RegistrationCta.useMemo[deadlineAt]"], [
        registrationDeadline
    ]);
    const regEndAt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RegistrationCta.useMemo[regEndAt]": ()=>toDate(registrationEnd)
    }["RegistrationCta.useMemo[regEndAt]"], [
        registrationEnd
    ]);
    const closedAt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RegistrationCta.useMemo[closedAt]": ()=>toDate(registrationsClosedAt)
    }["RegistrationCta.useMemo[closedAt]"], [
        registrationsClosedAt
    ]);
    const [now, setNow] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "RegistrationCta.useState": ()=>new Date()
    }["RegistrationCta.useState"]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RegistrationCta.useEffect": ()=>{
            const t = setInterval({
                "RegistrationCta.useEffect.t": ()=>setNow(new Date())
            }["RegistrationCta.useEffect.t"], 1000);
            return ({
                "RegistrationCta.useEffect": ()=>clearInterval(t)
            })["RegistrationCta.useEffect"];
        }
    }["RegistrationCta.useEffect"], []);
    const isHardClosed = !!closedAt;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            deadlineAt && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(RegistrationCta, "3Jk9AmytEXiNdGw6HkDely37UZg=");
_c = RegistrationCta;
var _c;
__turbopack_context__.k.register(_c, "RegistrationCta");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_2f31aaab._.js.map