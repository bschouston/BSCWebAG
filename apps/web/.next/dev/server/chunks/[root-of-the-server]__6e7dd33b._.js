...
"[project]/apps/web/src/app/api/tournaments/[tournamentId]/players/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    ...
    const snap = await adminDb.collection("tournaments").doc(tournamentId).collection("players").orderBy("createdAt", "desc").get();
...
async function POST(req, { params }) {
    ...
    const ref = adminDb.collection("tournaments").doc(tournamentId).collection("players").doc();
    await ref.set({
        displayName,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6e7dd33b._.js.map