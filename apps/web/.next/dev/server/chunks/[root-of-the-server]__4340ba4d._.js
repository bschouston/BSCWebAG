...
"[project]/apps/web/src/app/api/tournaments/[tournamentId]/matches/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    ...
    const snap = await adminDb.collection("tournaments").doc(tournamentId).collection("matches").orderBy("scheduledAt", "asc").get();
...
async function POST(req, { params }) {
    const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$auth$2f$server$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAdmin"])(req);
    ...
    if (!teamAId || !teamBId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "teamAId and teamBId required"
        }, {
            status: 400
        });
    }
    const scheduledAt = body?.scheduledAt ? __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$firestore__$5b$external$5d$__$28$firebase$2d$admin$2f$firestore$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$29$__["Timestamp"].fromDate(new Date(body.scheduledAt)) : null;
    const ref = adminDb.collection("tournaments").doc(tournamentId).collection("matches").doc();
    await ref.set({
        teamAId,
        teamBId,
        scheduledAt,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4340ba4d._.js.map