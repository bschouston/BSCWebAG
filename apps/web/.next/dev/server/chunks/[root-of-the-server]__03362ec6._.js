...
"[project]/apps/web/src/app/api/tournaments/[tournamentId]/teams/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    ...
    const snap = await adminDb.collection("tournaments").doc(tournamentId).collection("teams").orderBy("createdAt", "desc").get();
...
async function POST(req, { params }) {
    ...
    const ref = adminDb.collection("tournaments").doc(tournamentId).collection("teams").doc();
    await ref.set({
        name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__03362ec6._.js.map