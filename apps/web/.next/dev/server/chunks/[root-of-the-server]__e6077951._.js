...
"[project]/apps/web/src/app/api/admin/tournaments/convert/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function displayNameFromRegistration(reg) {
...
async function POST(req) {
    ...
    if (!eventId) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    if (!eventSnap.exists) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Event not found"
    }, {
        status: 404
    });
    const event = eventSnap.data();
    const tournamentStatus = body.status ?? (event?.status === "PUBLISHED" ? "ACTIVE" : "DRAFT");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e6077951._.js.map